  ...
  return (
    <div className="w-full h-full m-5 pb-2 pt-5">
      <div className="w-full h-fit md:h-36 flex flex-col md:flex-row justify-start items-center gap-10">
        <div className="w-44 md:w-1/6 h-40 md:h-full flex flex-col items-center justify-center border-2 rounded-2xl  bg-folly-800 shadow-lg">
          <span className=" text-folly-100 text-sm mb-2">نوشته ها</span>
          <span className={`text-7xl text-ghost-100  ${ChewyFont.className}`}>
            10
          </span>{" "}
        </div>
        <div className="w-44 md:w-3/6 h-fit md:h-full flex items-center rounded-2xl bg-avocado-500 shadow-lg">
          <div className="w-full flex flex-col md:flex-row  justify-evenly items-center p-2 md:p-0">
        ...
        <div className="w-44 md:w-2/6 h-40 flex items-center justify-center  rounded-2xl bg-cles-500 shadow-lg p-2 md:p-0">
          <div className="flex flex-col items-center justify-center">
      ...
      {/* <div className="w-full h-fit md:h-36 flex justify-start items-center gap-10">
        Quick Access
      </div>
      <div className="w-full h-fit md:h-36 flex justify-start items-center gap-10">
        Data
