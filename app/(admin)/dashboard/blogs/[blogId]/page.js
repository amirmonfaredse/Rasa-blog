...
import { getBlog } from "@/app/_data/data-services";
...
export default async function Page({ params }) {
  ...
  return (
    <form className="py-5">
        ...
        <label className="flex flex-col gap-3">
          ...
          <div className="w-full max-w-sm min-w-[200px]">
            <div className="relative">
              <select className="w-full h-[50px] bg-transparent placeholder:text-gray-100 text-slate-100 text-sm border border-slate-200 rounded p-2 py-1.5 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-100 shadow-sm focus:shadow-md appearance-none cursor-pointer">
                <option
      ...
      <Editor defaultContent={blog.content} />
